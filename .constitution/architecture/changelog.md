...
- Reframed substrate qualification as sequential and provisional while retaining the frozen common suite.
- Replaced the ARC-R02 mitigation with the SPK-B005 layout-cap follow-up.
- Recast structural debt as the retained contract seam and untriggered focused candidate build recipe rather than two live adapters.
