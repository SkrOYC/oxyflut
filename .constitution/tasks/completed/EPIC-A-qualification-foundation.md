...
- **Touched Files:** `xtask/src/contracts/native/ast.rs`.
- **Justification:** Review required splitting Clang AST and header-record helpers from the native contract validator to keep both modules within the repository file-size limit.
