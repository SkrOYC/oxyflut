...
- **Path B: full Flutter Engine.** Add a language-neutral runtime controller and C ABI to a pinned Flutter Engine fork. Retain the shell, rasterizer, compositor, frame pipeline, and platform embedders. Starling is an example of this. It demonstrates the architecture with Swift.
