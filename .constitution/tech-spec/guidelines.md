...
The following commands are the Stage 4 command contract. Only the documentation formatter exists in the repository at v0.9.0. Stage 4 can schedule implementation of the missing commands for qualification work only.
...
| Command | Purpose | Availability at v0.9.0 |
| :-- | :-- | :-- |
