...
| :-- | :-- | :-- |
| `accessibility-map.schema.json` | Records one candidate's complete forward property map and reverse action map for one environment. | `kk-complete` requires every forward mapping and reverse action to be KK; any native mapping change reruns API inspection and end-to-end assistive-technology tests. |
